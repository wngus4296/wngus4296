...
### 💻 I am
* studying development & security <br>
* majoring in Information security & Department of software convergence<br>
  
  
### 🎯 Projects
* [DooRiBon](https://github.com/TeamDooRiBon/DooRi-Server): 작은 움직임이 만드는 우리다운 여행 [Server Developer] <br>
* [고도의 전략](https://github.com/28th-SOPKATON/SOPKATON-server): 내 인맥, 나는 MBTI로 관리한다. 이게 바로 고도의 전략. [Server Developer] <br>
* [나도선배](https://github.com/TeamNado-Sunbae/NadoSunbae-Server): 제2전공생을 위한 학과 후기, 전공 정보 공유 플랫폼 [Server Developer] <br>
* [솝말잇기](https://github.com/word-relay/word-relay-server): 솝트인을 위한 릴레이 솝조어 생성기, 솝말잇기 [Server Developer] <br>
* [POME](https://github.com/TeamPOME/POME-iOS): 돈 쓸 때 무슨 생각해? 나를 위한 소비기록, Pay fOr ME [iOS Developer] <br>
